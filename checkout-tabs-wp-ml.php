...
require_once CHECKOUT_TABS_WP_ML_DIR . 'inc/ajax-auth-email.php';
require_once CHECKOUT_TABS_WP_ML_DIR . 'inc/ajax-check-email.php';
...
require_once CHECKOUT_TABS_WP_ML_DIR . 'inc/ajax-coupon.php';
