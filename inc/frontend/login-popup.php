...
add_action('wp_footer', function () {
	...
	<div id="login-popup" style="display:none; position: relative; width: 100%; padding: 20px; border-radius: 10px; background-color: #fff; box-sizing: border-box; max-width: 440px; margin: 20px auto;">
		...
		<div style="display:flex; gap: 10px; margin: 0 0 12px;">
			<button type="button" class="ctwpml-auth-tab is-active" data-tab="login" style="flex:1; padding:10px; border-radius: 8px; border:1px solid #ddd; background:#f5f5f5; font-weight:700; cursor:pointer;">Login</button>
			<button type="button" class="ctwpml-auth-tab" data-tab="signup" style="flex:1; padding:10px; border-radius: 8px; border:1px solid #ddd; background:#fff; font-weight:700; cursor:pointer;">Criar conta</button>
		</div>
		...
		<div class="ctwpml-auth-panel" data-tab="signup" style="display:none;">
			...
			<form id="ctwpml-signup-form" style="width: 100%; max-width: 400px; margin: 0 auto;">
				...
				<input type="text" id="ctwpml-signup-name" required style="display:block;width:100%;margin-bottom:10px;padding:10px;border-radius:6px;border:1px solid #979797;">

				<label for="ctwpml-signup-email" style="color: #000;">E-mail</label>
				<input type="email" id="ctwpml-signup-email" required style="display:block;width:100%;margin-bottom:10px;padding:10px;border-radius:6px;border:1px solid #979797;">
				...
				<input type="text" id="ctwpml-signup-cpf" required style="display:block;width:100%;margin-bottom:6px;padding:10px;border-radius:6px;border:1px solid #979797;">
				...
				<button type="submit" id="ctwpml-signup-submit" style="background-color:#0075FF;color:#fff;border:0;cursor:pointer;display:block;width:100%;margin-top:10px;padding:10px;border-radius:7px;font-weight:700;">
					Criar conta
				</button>
